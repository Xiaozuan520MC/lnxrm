...
typedef int (*pci_match_fn)(void *ctx, u8 bus, u8 dev, u8 fn, u16 vendor, u16 devid, u8 base_class);
...
/* AHCI/SATA controller (drivers/ahci.cpp) — a PCI class 01h/06h device. */
void ahci_init(void);
