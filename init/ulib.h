...
static inline long kfb_info(struct fb_info *info)
{
...
static inline long kfb_fill(struct fb_rect *r)
{
    return syscall1(SYS_fb_fill, (long)r);
}
static inline long kfb_char(struct fb_char *c)
{
    return syscall1(SYS_fb_char, (long)c);
}
static inline long kfb_puts(struct fb_str *s)
{
